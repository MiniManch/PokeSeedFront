<template>
  <div class="changePoke">
    <div class="selectedPoke">
      <img
        class="pokemonProfileImage"
        :src="selectedPoke.pokeDexImg"
        @error="useFrontSprite(selectedPoke)"
        alt=""
      />
      <div class="pokeStats">
        ...
        <div class="healthBar">
          <div class="bar-background">
            ...
            <div
              class="bar"
              :style="{
                width: `${widthOfHealthBar(selectedPoke)}%`,
                backgroundColor: healthBarColor(selectedPoke),
              }"
            ></div>
          </div>
        </div>
    ...
    <div class="availablePoke">
      <div
        :class="['poke', currentPokemon === poke ? justifyStart : null]"
        class="poke"
        v-for="poke in relevantPoke"
        :key="poke.name"
      >
            ...
            <div class="healthBar">
              <div class="bar-background">
                ...
                <div
                  class="bar"
                  :style="{
                    width: `${widthOfHealthBar(poke)}%`,
                    backgroundColor: healthBarColor(poke),
                  }"
                ></div>
              </div>
            </div>
  ...
  <button class="back" @click="closeWindow">
    <img src="../../../public/Images/back/back-50.png" alt="" id="backButtonImage" />
  </button>
</template>
